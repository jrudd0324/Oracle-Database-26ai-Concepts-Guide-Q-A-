...
**Answer:** Use the `AS SEED` option when creating the PDB. Be sure to open the seed, sync it, and return it to read-only. You must be connected to the application root.
